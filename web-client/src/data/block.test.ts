...
describe("fromBlockResult", () => {
  let blockResult: GetBlockResultWithTransactions;

  beforeEach(() => {
    blockResult = fakeGetBlockResult();
  });
...
function fakeGetBlockResult(): GetBlockResultWithTransactions {
  return {
    timestamp: "timestamp",
    producer: "producer",
    confirmed: 0,
    ...
    transactions: [
      ...
      },
      {
        ...
        trx: {
          id:
            "dab8563a9e1aafe906b890ea886991265661496a64b3cc8be9ca8f1321c1aebe",
          signatures: [
